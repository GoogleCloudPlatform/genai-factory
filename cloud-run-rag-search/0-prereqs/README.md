# Cloud Run - RAG with Vector Search / Prerequisites

This stage is part of the `Cloud Run RAG - Vector Search` factory.
...
networking_config = {
  create          = false
  host_project_id = "my-existing-host-project-id"
  subnet = {
    name = "my-existing-subnet"
  subnet_proxy_only = {
    name = "my-existing-proxy-only-subnet"
  }
  vpc_name = "my-existing-network"
}
```

This is useful if your shared VPC is managed by someone else, outside this factory.
<!-- BEGIN TFDOC -->
## Variables
