# Gemini Enterprise for Customer Experience (GECX) - Dialogflow CX / Prerequisites stage
...
| [region](variables.tf#L69) | The region where to create the buckets. | <code>string</code> |  | <code>&#34;europe-west1&#34;</code> |

## Outputs

| name | description | sensitive |
|---|---|:---:|
| [buckets](outputs.tf#L73) | Created buckets. |  |
| [networking_config](outputs.tf#L78) | The networking configuration. |  |
| [projects](outputs.tf#L83) | Created projects. |  |
| [region](outputs.tf#L88) | The region where to create the resources. |  |
| [service_accounts](outputs.tf#L93) | Created service accounts. |  |
<!-- END TFDOC -->
