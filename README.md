...
Works with Cloud Foundation Fabric from [v47.0.0](https://github.com/GoogleCloudPlatform/cloud-foundation-fabric/tree/v47.0.0) to [v52.0.0](https://github.com/GoogleCloudPlatform/cloud-foundation-fabric/tree/v52.0.0).
...
- [Conversational agent (Dialogflow CX)](./conversational-dialogflow-cx/README.md) - A chat engine ([Dialogflow CX](https://cloud.google.com/dialogflow/docs)) backed by two data stores, reading csv and json data from a GCS bucket.
