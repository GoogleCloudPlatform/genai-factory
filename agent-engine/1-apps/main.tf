...
module "agent" {
  source                     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/agent-engine?ref=v56.2.0"
  name                       = var.name
...
module "firestore" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/firestore?ref=v56.2.0"
  project_id = var.project_id
  database = {
    name        = var.name
