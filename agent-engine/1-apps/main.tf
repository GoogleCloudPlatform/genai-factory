...
module "agent" {
  source                     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/agent-engine?ref=v58.0.0"
  name                       = var.name
...
module "firestore" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/firestore?ref=v58.0.0"
  project_id = var.project_id
  database = {
    name        = var.name
