...
This is useful if your networking stack (shared VPC, subnet, network attachment, proxy) are created and managed by someone else, outside the factory.
<!-- BEGIN TFDOC -->
## Variables
