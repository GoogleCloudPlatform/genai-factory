# Gemini Enterprise Agent Platform / Prerequisites stage
...
This is useful if your networking stack (Shared VPC, subnets) is created and managed outside the factory.
<!-- BEGIN TFDOC -->
## Variables
