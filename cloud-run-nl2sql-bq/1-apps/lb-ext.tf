...
locals {
  address_ext_glb = try(coalesce(
    ...
    module.address-ext-glb[0].global_addresses["nl2sql-0-ext-glb-01"].address
  ), null)
}
...
module "lb_ext_glb_redirect" {
  count               = var.lbs_configs.external.enable ? 1 : 0
  source              = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/net-lb-app-ext?ref=v57.0.0"
  project_id          = var.project_id
