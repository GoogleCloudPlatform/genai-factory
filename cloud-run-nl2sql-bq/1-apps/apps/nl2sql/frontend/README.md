...
# Create or update a user session for bigquery_agent
curl -X POST ${APP_ADDRESS}/apps/bigquery_agent/users/user_123/sessions/session_abc \
    -H "Authorization: Bearer $(gcloud auth print-identity-token)" \
    -H "Content-Type: application/json" \
    -d '{"state": {"preferred_language": "English", "visit_count": 5}}'

# Query bigquery_agent
...
More info on BigQuery tools in ADK can be found [here](https://google.github.io/adk-docs/integrations/bigquery/).
