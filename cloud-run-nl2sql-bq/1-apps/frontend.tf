...
module "cloud_run_frontend" {
  source              = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/cloud-run-v2?ref=v54.3.0"
  ...
  service_account_config = {
    create = false
    email  = var.service_accounts["project/gf-nl2sql-bq-fe-0"].email
  }
