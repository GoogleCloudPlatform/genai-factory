...
module "ds-bucket" {
  source        = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/gcs?ref=v46.1.0"
...
module "dialogflow" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/ai-applications?ref=v46.1.0"
  name       = var.name
  project_id = var.project_config.id
