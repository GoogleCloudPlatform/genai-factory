...
module "alloydb" {
  source              = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/alloydb?ref=v58.0.0"
  project_id          = var.project_id
...
module "psc_consumer_address" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/net-address?ref=v58.0.0"
  project_id = var.project_id
  internal_addresses = {
    (var.name) = {
      region     = var.region
...
module "psc_consumer_dns_zone" {
  source        = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/dns?ref=v58.0.0"
  project_id    = var.project_id
