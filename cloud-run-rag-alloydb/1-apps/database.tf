...
module "alloydb" {
  source              = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/alloydb?ref=v57.0.0"
  project_id          = var.project_id
...
module "psc_consumer_address" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/net-address?ref=v57.0.0"
  project_id = var.project_id
  internal_addresses = {
    (var.name) = {
      region     = var.region
